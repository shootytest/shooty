...
player_make.penta = {
  shapes: [
    { type: "circle", x: 0, y: 0, body: true, },
    { type: "circle", x: 0, y: 0, r: 0.8, color: C.neon_blue },
    { type: "circle_fade", x: 0, y: 0, r: "shootsize*1", shoot_index: 0, color: C.player_bullet },
    { type: "circle_fade", x: 0, y: 0.3, r: "shootsize*1", shoot_index: 1, color: C.player_bullet },
    { type: "circle_fade", x: 0, y: -0.3, r: "shootsize*1", shoot_index: 2, color: C.player_bullet },
    { type: "circle_fade", x: 0, y: 0.15, r: "shootsize*1", shoot_index: 3, color: C.player_bullet },
    { type: "circle_fade", x: 0, y: -0.15, r: "shootsize*1", shoot_index: 4, color: C.player_bullet },
  ],
  shoots: [
    "delete",
...
player_make.oct = {
  shapes: [
    { type: "circle", x: 0, y: 0, body: true, },
    { type: "circle", x: 0, y: 0, r: 0.8, color: C.neon_blue },
    { type: "circle_fade", x: 0, y: 0, r: "shootsize*1", shoot_index: 4, color: C.neon_blue },
    { type: "circle_fade", x: 0, y: 0.3, r: "shootsize*1", color: C.neon_blue },
    { type: "circle_fade", x: 0.3, y: 0, r: "shootsize*1", color: C.neon_blue },
    { type: "circle_fade", x: 0, y: -0.3, r: "shootsize*1", color: C.neon_blue },
    { type: "circle_fade", x: -0.3, y: 0, r: "shootsize*1", color: C.neon_blue },
  ],
  shoots: [
...
player_make.lobster = {
  shapes: [
    { type: "circle", x: 0, y: 0, body: true, },
    { type: "circle", x: 0, y: 0, r: 0.8, color: C.neon_blue },
    { type: "circle_fade", x: 0, y: 0, r: "shootsize*1", shoot_index: 0, color: C.bright_blue },
    { type: "circle_fade", x: 0, y: 0.3, r: "shootsize*1", shoot_index: 1, color: C.bright_blue },
    { type: "circle_fade", x: 0, y: -0.3, r: "shootsize*1", shoot_index: 2, color: C.bright_blue },
    { type: "circle_fade", x: 0, y: 0.15, r: "shootsize*1", shoot_index: 3, color: C.bright_blue },
    { type: "circle_fade", x: 0, y: -0.15, r: "shootsize*1", shoot_index: 4, color: C.bright_blue },
  ],
  shoots: [
    "delete",
    { parent: shoots.p_lobster, rotation: 30, color: C.bright_blue, delay: 10, },
    { parent: shoots.p_lobster, rotation: 15, color: C.bright_blue, delay: 5, },
    { parent: shoots.p_lobster, rotation: 0, color: C.bright_blue, },
    { parent: shoots.p_lobster, rotation: -15, color: C.bright_blue, delay: 5, },
    { parent: shoots.p_lobster, rotation: -30, color: C.bright_blue, delay: 10, },
    { parent: shoots.p_lobster, rotation: 210, color: C.bright_blue, delay: 10, },
    { parent: shoots.p_lobster, rotation: 195, color: C.bright_blue, delay: 5, },
    { parent: shoots.p_lobster, rotation: 180, color: C.bright_blue, },
    { parent: shoots.p_lobster, rotation: 165, color: C.bright_blue, delay: 5, },
    { parent: shoots.p_lobster, rotation: 150, color: C.bright_blue, delay: 10, },
  ],
};
